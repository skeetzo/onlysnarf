...
def attempt_chrome():
    ...
    try:
        ...
        if str(processor) == "aarch64":
            ...
            browserAttempt = ChromeWebDriver(service=ChromeService(executable_path="/usr/bin/chromedriver", log_path=DEFAULT.LOG_PATH_CHROMEDRIVER, service_args=configure_service_args()), options=configure_chrome_options())
